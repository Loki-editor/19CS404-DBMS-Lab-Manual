...
## 2. Write a PL/SQL program to generate Fibonacci series
## program
```
DECLARE
    n NUMBER := 7;
...
## 3. Write a PL/SQL program to find the Greatest of Two Numbers
## program:
```
DECLARE
    num1 NUMBER := 80;
...
## 5. Write a PL/SQL program to Calculate Sum of First N Natural Numbers
## program
```
DECLARE
    n NUMBER := 10;
